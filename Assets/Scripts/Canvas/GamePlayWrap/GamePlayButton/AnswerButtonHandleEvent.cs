...
public class AnswerButtonHandleEvent : MonoBehaviour
{
    ...
    [SerializeField] AnswerButtonHandleEffect ref_AnswerButtonHandleEffect;
    ...
    private void Start()
    {
        ...
        CheckIsNotNull(ref_AudioManagerSources, "ref_AudioManagerSources in AnswerButtonHandleEvent");
        CheckIsNotNull(ref_AudioManagerSFX, "ref_AudioManagerSFX in AnswerButtonHandleEvent");
        CheckIsNotNull(ref_AnswerButtonHandleEffect, "ref_AnswerButtonHandleEffect in AnswerButtonHandleEvent");
    }
    ...
    public void OnClickAnswerButton()
    {
        ...
        {
            //effect
            ref_AnswerButtonHandleEffect.HandleColorEffect(false);

            //Audio
            AudioClip false_sfx = ref_AudioManagerSources.SFX_false_aws_;
            ref_AudioManagerSFX.PlaySFX(false_sfx);
        ...
        /*IF choie is true*/
        //Audio
        AudioClip true_sfx = ref_AudioManagerSources.SFX_true_aws_;
        ref_AudioManagerSFX.PlaySFX(true_sfx);

        //effect
        ref_AnswerButtonHandleEffect.HandleColorEffect(true);
        ...
        ref_GameManagerData.game_score_ += score_with_time;     //Update score
        ref_GameManagerData.correct_ans_ ++;
        ref_GameManagerUpDateQuiz.UpdateQuiz();                 //update quiz
    }
}
